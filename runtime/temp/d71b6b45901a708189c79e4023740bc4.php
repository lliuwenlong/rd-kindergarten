<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view/staff/show.html";i:1548654014;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['staff_id']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['staff_name']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['j_name']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['post_name']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['staff_tel']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['garden_name']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['rank_name']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['standard_name']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php if($vo[staff_status] == 1){ echo "在职";}else{ echo "离职";}  ?></div>
                            </td>
                            <td align="left" class="">
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Staff/staff_del'); ?>" data-id="<?php echo $vo['staff_id']; ?>" data-table="staff" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                                    <a href="<?php echo U('Staff/desc',array('id'=>$vo['staff_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>详情</a>
                                </div>
                            </td>
...
<script>
    $(document).on('click',".cl",function(){
        ...
        $.ajax({
            url:"/index.php?m=Admin&c=Staff&a=getstaffData",
            data:{"arr":arr},
            type:'post',
            dataType:'json',
            success:function(res){
                ...
                $.each(res,function(i,vo){
                    str +=`
                         <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.staff_id}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.staff_name}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.j_name}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.post_name}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.staff_tel}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.garden_name}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.rank_name}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.standard_name}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">`;
                    if(vo.staff_status==1){
                        str +='在职'
                    }else{
                        str +='离职'
                    }
                        ...
                        str+=`
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Staff/staff_del'); ?>" data-id="${vo.staff_id}" data-table="staff" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                                    <a href="/index.php/admin/Staff/desc?id=${vo.staff_id}" class="btn blue"><i class="fa fa-pencil-square-o"></i>详情</a>
                                </div>
                            </td>
                            <td align="" class="" style="width: 100%;">
                                <div>&nbsp;</div>
    ...
    function delfun(obj) {
        ...
        layer.confirm('确认删除？', {
            ...
            $.ajax({
                type: 'post',
                url: $(obj).attr('data-url'),
                data : {act:'del',admin_id:$(obj).attr('data-admin_id'),id:$(obj).attr('data-id'),table:$(obj).attr('data-table')},
                dataType: 'json',
                success: function (data) {
