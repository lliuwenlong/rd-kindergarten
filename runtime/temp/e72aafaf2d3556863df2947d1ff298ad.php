<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view/dynamic/index.html";i:1548654012;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="uploadForm" method="post" enctype="multipart/form-data">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="d_title" value="<?php echo $info['user_name']; ?>" id="d_title" maxlength="20" class="input-txt">
