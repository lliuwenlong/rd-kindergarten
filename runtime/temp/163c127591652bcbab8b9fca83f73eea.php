<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view/staff/position.html";i:1548670255;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="article_show" axis="col5" class="">
                            <div style="text-align: left; width: 100px;" class="">所属幼儿园</div>
                        </th>
                        <th align="center" abbr="article_show" axis="col5" class="">
                            <div style="text-align: left; width: 100px;" class="">所属班级</div>
                        </th>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a href="<?php echo U('Staff/position_info'); ?>">
                        <div class="add" title="添加管理员">
                            <span><i class="fa fa-plus"></i>添加职位</span>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="bDiv" style="height: auto;">
            <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
                <table>
                    <tbody id="tbd">
                    <?php if(is_array($post) || $post instanceof \think\Collection || $post instanceof \think\Paginator): if( count($post)==0 ) : echo "" ;else: foreach($post as $k=>$vo): ?>
                        <tr>
                            <td class="sign">
                                <div style="width: 24px;"><i class="ico-check"></i></div>
                            </td>
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Staff/post_del'); ?>" data-id="<?php echo $vo['id']; ?>"  onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                                </div>
                            </td>
...
<script>
    $(document).on('click',".cl",function(){
        ...
        // console.log(arr);
        $.ajax({
            url:"/index.php?m=Admin&c=Staff&a=getData",
            data:{"arr":arr},
            type:'post',
            // traditional :true,
            dataType:'json',
                ...
                $.each(res,function(i,vo){
                    str +=`
                         <tr>
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Staff/post_del'); ?>" data-id="${vo.id}"  onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                                </div>
                            </td>
                            <td align="" class="" style="width: 100%;">
                                <div>&nbsp;</div>
