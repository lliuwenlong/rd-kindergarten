<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/admin/view/admin/login.html";i:1548654011;}*/ ?>
<!doctype html>
...
<body>
	<div class="login-layout">
    	<div class="logo">
            <h3 style="font-size: 40px; color:white; text-align:center;">幼儿园管理系统</h3>
        </div>
