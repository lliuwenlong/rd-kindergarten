<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view/staff/promote.html";i:1548734229;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">晋升时间</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">晋升次数</div>
                        </th>
                ...
                <table>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['promote_time']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['promote_number']; ?></div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a href="<?php echo U('Staff/promote_save',array('id'=>$vo['ji_id'],'staff_id'=>$vo['staff_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>晋升</a>
...
<script>
    $(document).on('click',".cl",function(){
        ...
        $.ajax({
            url:"/index.php?m=Admin&c=Staff&a=getpromoteData",
            data:{"arr":arr},
            type:'post',
            dataType:'json',
            success:function(res){
                ...
                $.each(res,function(i,vo){
                    str +=`
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.promote_time}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.promote_number}</div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a href="<?php echo U('Admin/admin_info',array('admin_id'=>$vo['admin_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>晋升</a>
