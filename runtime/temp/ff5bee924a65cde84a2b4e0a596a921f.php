<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/menu/admin_info.html";i:1548654012;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="adminHandle" method="post">
        ...
        <input type="hidden" name="p_id" value="<?php echo $info['id']; ?>">
        <input type="hidden" name="auth_code" value="<?php echo \think\Config::get('AUTH_CODE'); ?>"/>
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="user_name"><em>*</em>菜单名</label>
                </dt>
                <dd class="opt">
...
<script type="text/javascript">
    ...
    function adsubmit(){
        ...
        $.ajax({
            async:false,
            url:'/index.php?m=Admin&c=Menu&a=menuHandle&t='+Math.random(),
