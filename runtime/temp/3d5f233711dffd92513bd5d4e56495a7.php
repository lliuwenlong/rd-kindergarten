<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/staff/garden.html";i:1548743935;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="article_title" axis="col3" class="">
                            <div style="text-align: left; width: 100px;" class="">幼儿园名称</div>
                        </th>
                        <th align="left" abbr="article_title" axis="col3" class="">
                            <div style="text-align: left; width: 100px;" class="">负责人</div>
                        </th>
                        <th align="left" abbr="article_title" axis="col3" class="">
                            <div style="text-align: left; width: 100px;" class="">编辑</div>
                        </th>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a href="<?php echo U('Staff/garden_info'); ?>">
                        <div class="add" title="添加管理员">
                            <span><i class="fa fa-plus"></i>添加园所</span>
                        </div>
                    </a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <!--<a href="<?php echo U('Admin/admin_info',array('admin_id'=>$vo['admin_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>删除</a>-->
                                    <a class="btn red"  href="javascript:void(0)" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                                </div>
                            </td>
...
<div class="flexigrid">
        ...
        <div class="hDivBox">
            <table cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <th align="left" abbr="article_title" axis="col3" class="">
                        <div style="text-align: left; width: 100px;" class="">班级名称</div>
                    </th>
                    <th align="left" abbr="article_title" axis="col3" class="">
                        <div style="text-align: left; width: 100px;" class="">编辑</div>
                    </th>
    ...
    <div class="bDiv" style="height: auto;">
        <div id="flexigrid" cellpadding="0" cellspacing="0" border="0">
            <table>
                <tbody>
                <?php if(is_array($class) || $class instanceof \think\Collection || $class instanceof \think\Paginator): if( count($class)==0 ) : echo "" ;else: foreach($class as $k=>$vo): ?>
                    <tr>
                        <td class="sign">
                            <div style="width: 24px;"><i class="ico-check"></i></div>
                        </td>
...
<script>
    ...
    function delfun(obj) {
        ...
        layer.confirm('确认删除？', {
            ...
            $.ajax({
                type: 'post',
                url: '/index.php/Admin/Staff/class_del',
