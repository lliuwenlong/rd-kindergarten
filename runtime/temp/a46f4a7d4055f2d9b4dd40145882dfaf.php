<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/staff/branch.html";i:1548670454;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a href="<?php echo U('Staff/branch_info'); ?>">
                ...
                <table>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['p_name']; ?></div>
                            </td>
                            <td align="left" class="">
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    ...
                                    <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Staff/branch_id',array('id'=>$vo[id])); ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                                </div>
                            </td>
