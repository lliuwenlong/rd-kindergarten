<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./application/admin/view/staff/journal_list.html";i:1548668654;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">今日工作描述</div>
                        </th>
                        <th align="center" abbr="article_show" axis="col5" class="">
                            <div style="text-align: left; width: 100px;" class="">明日工作计划</div>
                        </th>
                         <th align="center" abbr="article_show" axis="col5" class="">
                            <div style="text-align: left; width: 100px;" class="">时间</div>
                        </th>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a href="<?php echo U('Staff/journal_add'); ?>">
                        <div class="add" title="添加管理员">
                            <span><i class="fa fa-plus"></i>添加工作日志</span>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <table>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['today_desc']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['ming_desc']; ?></div>
                            </td>
                             <td align="left" class="">
                                <div style="text-align: left; width: 100px;">
                                <?php echo date("Y-m-d",$vo['addtime']); ?></div>
                            </td>

                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a href="<?php echo U('Staff/journal_edit',array('id'=>$vo['id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                                    
                                        <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Staff/journal_del'); ?>" data-id="<?php echo $vo['id']; ?>" data-garden_id="<?php echo $vo['garden_id']; ?>" data-post_id="<?php echo $vo['post_id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
...
<script>
    $(document).on('click',".cl",function(){
        ...
        // console.log(arr);
        $.ajax({
            url:"/index.php?m=Admin&c=Staff&a=getjournalData",
            data:{"arr":arr},
            type:'post',
            // traditional :true,
            dataType:'json',
  ...
  <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.today_desc}</div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.ming_desc}</div>
                            </td>
                             <td align="left" class="">
                                <div style="text-align: left; width: 100px;">
                                ${vo.addtime}</div>
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a href="/index.php?m=Admin&c=Staff&a=journal_edit&id=${vo.id}" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>

                                        <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Staff/journal_del'); ?>" data-id="${vo.id}" data-garden_id="${vo.garden_id}" data-post_id="${vo.post_id}" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
