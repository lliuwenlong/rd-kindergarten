<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/spare/index.html";i:1548654013;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">初始备用金</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">收入/支出来源</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">收入/支出金额</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">剩余备用金</div>
                        </th>
                ...
                <table>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['chu_money']; ?></div>
                            </td>
                            <td align="left" class="">
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['yu_money']; ?></div>
                            </td>
...
<script>
    ...
    $(document).on('click',".cl",function(){
        ...
        // console.log(arr);
        $.ajax({
            url:"/index.php?m=Admin&c=Spare&a=getData",
            data:{"arr":arr},
            type:'post',
            // traditional :true,
            dataType:'json',
                ...
                $.each(res,function(i,vo){
                    str +=`
                          <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.chu_money}</div>
                            </td>
                            <td align="left" class="">
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.yu_money}</div>
                            </td>
