<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./application/admin/view/people/add.html";i:1548654013;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="adminHandle" method="post">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="email"><em>*</em>手机号码</label>
                </dt>
                <dd class="opt">
                    <input type="text" name="tel" value="<?php echo $info['tel']; ?>" id="tel" class="input-txt" maxlength="40">
                    <span class="err" id="err_email"></span><p class="notic">手机号码</p>
                </dd>
...
<script type="text/javascript">
    ...
    function adsubmit(){
        ...
        $.ajax({
            async:false,
            url:'/index.php?m=Admin&c=People&a=add&t='+Math.random(),
