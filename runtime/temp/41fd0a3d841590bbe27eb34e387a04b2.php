<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/teach/statement.html";i:1548654015;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	<div class="fixed-bar">
		...
		<table border="1" style="background-color: red;text-align: center;">
			...
			<tbody id="tbd">
				<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$val): if(is_array($val['son']) || $val['son'] instanceof \think\Collection || $val['son'] instanceof \think\Paginator): if( count($val['son'])==0 ) : echo "" ;else: foreach($val['son'] as $key=>$v): ?>
