<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view/classify/admin_info.html";i:1548654012;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="adminHandle" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="category_name" value="<?php echo $info['category_name']; ?>" id="user_name" maxlength="20" class="input-txt">
