<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view/shan/menu_type_list.html";i:1548654013;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
						...
						<tr id="<?php echo $vo['id']; ?>">
							...
							<td align="left" class="cl" state="0" type="nl" axis="col4">
								<div style="text-align: left; width: 200px;">
									 ...
									 <a href="/index.php?m=Admin&c=Shan&a=hou_menu_type_edit&id=<?php echo $vo['id']; ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a>
                    <a class="btn red"  href="/index.php?m=Admin&c=Shan&a=hou_menu_type_del&id=<?php echo $vo['id']; ?>"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
