<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/expend/index.html";i:1548660743;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">支出</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                ...
                <table>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class=""><div style="text-align: left; width: 100px;"><?php echo $vo['money']; ?></div></td>
                            <td align="left" class="">
                            ...
                            <td align="left" class=""><div style="text-align: left; width: 100px;"><?php  if($vo[status] == 1){ echo "均衡/金额:$vo[money]/月均衡:$vo[money]";}else{ echo "常规:$vo[money]";} ?></div></td>
                            <td align="left" class="">
        ...
        <!--分页位置-->
        <!--<div class="page_01">-->
            <!--<a href="/index.php/Admin/Expend/index?page=<?php echo $page['pageUp']; ?>" class="page_02">上一页</a>-->
            <!--<a href="/index.php/Admin/Expend/index?page=<?php echo $page['pageNe']; ?>" class="page_02">下一页</a>-->
        <!--</div>-->
...
<script>
    $(document).on('click',".cl",function(){
        ...
        // console.log(arr);
        $.ajax({
            url:"/index.php?m=Admin&c=Expend&a=getindexData",
            data:{"arr":arr},
            type:'post',
            // traditional :true,
            dataType:'json',
