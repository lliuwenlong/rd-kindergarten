<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/inform/index.html";i:1548724629;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="uploadForm" method="post" enctype="multipart/form-data">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="inform_title"><em>*</em>标题</label>
                </dt>
                <dd class="opt">
                    <input type="text" name="inform_title" value="<?php echo $info['user_name']; ?>" id="inform_title" maxlength="20" class="input-txt">
                    <span class="err" id="err_inform_title"></span>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label for="inform_desc"><em>*</em>内容</label>
                </dt>
                <dd class="opt">
                    <textarea name="inform_desc" id="inform_desc" cols="50" rows="50"></textarea>
            ...
            <dd class="opt">
                <input type="file" name="d_photo" maxlength="18" value="<?php echo $info['password']; ?>" id="d_photo[]" class="input-txt">
            </dd>

            </dl>
            <dl class="row">
                <dt class="tit">
                    <label for="inform_type"><em>*</em>通知选择</label>
                </dt>
                <dd class="opt">
                    <input type="text" name="inform_type" maxlength="18" value="<?php echo $info['password']; ?>" id="inform_type" class="input-txt">
...
<script type="text/javascript">
    ...
    function adsubmit(){
        ...
        $.ajax({
            ...
            url:'/index.php?m=Admin&c=Inform&a=InformHandle&t='+Math.random(),
            data: formData,
            type:'post',
            dataType:'json',
            success:function(data){
