<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/staff/dimission.html";i:1548654013;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">离职时间</div>
                        </th>
                ...
                <table>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['dimission_date']; ?></div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <?php if($vo['staff_status'] == 1){ ?>
                                        <a href="javascript:void(0)" data-href="<?php echo U('Staff/dimission'); ?>" data-id="<?php echo $vo['staff_id']; ?>" data-staff_status="0" class="btn blue dimission"><i class="fa fa-pencil-square-o"></i>离职</a>
                                    <?php }else{ } ?>
...
<script>
    $(document).on('click',".cl",function(){
        ...
        $.ajax({
            url:"/index.php?m=Admin&c=Staff&a=getdimissionData",
            data:{"arr":arr},
            type:'post',
            dataType:'json',
            success:function(res){
                ...
                $.each(res,function(i,vo){
                    ...
                    str +=`
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.dimission_date}</div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">`;
                               if(vo.staff_status==1){
                                    str +=`<a href="javascript:void(0)" data-href="<?php echo U('Staff/dimission'); ?>" data-id="${vo['staff_id']}" data-staff_status="0" class="btn blue dimission"><i class="fa fa-pencil-square-o"></i>离职</a>`;
                               }else{
                               str +=``
                               }
    ...
    $(document).on('click',".dimission",function(){
        // alert(1)
        event.preventDefault();
        var url = $(this).attr("data-href");
        var obj = $(this);
        var staff_id = obj.attr("data-id")
        var staff_status = obj.attr("data-staff_status")
        layer.confirm('确认离职？', {
            btn: ['确定', '取消'] //按钮
        }, function () {
            $.ajax({
                url:url,
                data:{staff_id:staff_id,staff_status:staff_status},
                type:"post",
                dataType:"json",
                success:function (data) {
                    obj.parents("td").prev().children().html(data.data)
                    obj.parents("td").prev().prev().children().html("离职")
                    obj.remove();
    ...
    function delfun(obj) {
        ...
        layer.confirm('确认删除？', {
            ...
            $.ajax({
                type: 'post',
                url: $(obj).attr('data-url'),
                data : {act:'del',admin_id:$(obj).attr('data-admin_id'),id:$(obj).attr('data-id'),branch_id:$(obj).attr('data-branch_id')},
                dataType: 'json',
                success: function (data) {
