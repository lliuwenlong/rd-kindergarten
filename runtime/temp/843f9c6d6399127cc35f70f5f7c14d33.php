<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/statement/single.html";i:1548657316;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="flexigrid">
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">当日收入</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">当日支出</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
        ...
        <div class="bDiv" style="height: auto;">
            <div id="flexigrid" class="test_01" cellpadding="0" cellspacing="0" border="0">
                <table>
                    <tbody id="tbd">
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): if(is_array($vo['garden']) || $vo['garden'] instanceof \think\Collection || $vo['garden'] instanceof \think\Paginator): if( count($vo['garden'])==0 ) : echo "" ;else: foreach($vo['garden'] as $key=>$v): if(is_array($v['son']) || $v['son'] instanceof \think\Collection || $v['son'] instanceof \think\Paginator): if( count($v['son'])==0 ) : echo "" ;else: foreach($v['son'] as $ke=>$val): ?>
                            <tr>
                                <td class="sign">
                                    <div style="width: 24px;"><i class="ico-check"></i></div>
                                </td>
                                ...
                                <td align="left" class="">
                                    <div style="text-align: left; width: 100px;"><?php echo $v['name']; ?></div>
                                </td>
                                <td align="left" class="">
                                    <div style="text-align: left; width: 100px;"><?php echo $val['shou']['0']; ?></div>
                                </td>

                                <td align="left" class="">
                                    <div style="text-align: left; width: 100px;"><?php echo $val['chu']['0']; ?></div>
                                </td>
                                <td align="left" class="">
                                    <div style="text-align: left; width: 100px;"><?php echo $ke; ?></div>
                                </td>
...
<script>
    ...
    $(document).on('click',".cl",function(){
        ...
        // console.log(arr);
        $.ajax({
            url:"/index.php?m=Admin&c=Statement&a=getsingleData",
            data:{"arr":arr},
            type:'post',
            // traditional :true,
            dataType:'json',
            success:function(res){
                // console.log(res)
                str ='';
                $.each(res,function(key,vo){
                    $.each(vo.garden,function(k,v){
                       $.each(v.son,function(i,val){
                           str +=`
                                  <tr>
                                        <td class="sign">
                                            <div style="width: 24px;"><i class="ico-check"></i></div>
                                        ...
                                        <td align="left" class="">
                                            <div style="text-align: left; width: 100px;">${v.name}</div>
                                        </td>
                                        <td align="left" class="">
                                            <div style="text-align: left; width: 100px;">${val.shou[0]}</div>
                                        </td>

                                        <td align="left" class="">
                                            <div style="text-align: left; width: 100px;">${val.chu[0]}</div>
                                        </td>
                                        <td align="left" class="">
                                            <div style="text-align: left; width: 100px;">${i}</div>
                                        </td>
