<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view/custody/index.html";i:1548661641;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">入库/入库</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">摘要</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">结余</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">操作人</div>
                        </th>
                ...
                <table>
                    ...
                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php if($vo[status] == 1){ echo "入库";}else{ echo "出库";}  ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['desc']; ?></div>
                            </td>
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php if($vo[status] == 1){ echo $vo[sum]+$vo[number];}else{ echo $vo[sum]-$vo[number];}  ?></div>
                            </td>
                            <td align="left" class="">
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Custody/del'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                                    <!--<a href="<?php echo U('Admin/admin_info',array('admin_id'=>$vo['admin_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>详情</a>-->
                                </div>
                            </td>
...
<script>
    $(document).on('click',".cl",function(){
        ...
        $.ajax({
            url:"/index.php?m=Admin&c=Custody&a=getData",
            data:{"arr":arr},
            type:'post',
            dataType:'json',
            success:function(res){
                ...
                $.each(res,function(i,vo){
                    ...
                    if(vo.status==1){str+="入库"}else{str+="出库"}
                    str+=`
                                </div>
                            </td>
                            <td align="left" class="">
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">`;
                    if(vo.status==1){str+=vo.sum+vo.number}else{str+=vo.sum-vo.number}
                ...
                str+=   `</div>
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Custody/del'); ?>" data-id="${vo.id}" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                                    <!--<a href="<?php echo U('Admin/admin_info',array('admin_id'=>$vo['admin_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>详情</a>-->
                                </div>
                            </td>
                            <td align="" class="" style="width: 100%;">
