<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view/staff/backbone.html";i:1548730729;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">所属部门/班级</div>
                        </th>
                        <th align="left" abbr="ac_id" axis="col4" class="">
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">入职日期</div>
                        </th>
                ...
                <table>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['entry_date']; ?></div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <?php if($vo[backbone_status] == 0){  ?>
                                    <a href="<?php echo U('Staff/backbone',array('backbone_status'=>1,'staff_id'=>$vo['staff_id'])); ?>" class="btn blue backbone" ><i class="fa fa-pencil-square-o"></i>生成</a>
                                    <?php } ?>
...
<script>
    $(document).on('click',".cl",function(){
        ...
        $.ajax({
            url:"/index.php?m=Admin&c=Staff&a=getbackboneData",
            data:{"arr":arr},
            type:'post',
            dataType:'json',
            success:function(res){
                ...
                $.each(res,function(i,vo){
                    str +=`
                       <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.entry_date}</div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">`;
                                   if(vo.backbone_status == 0){
                                   str +=` <a href="/index.php/Admin/Staff/backbone?backbone_status=1&staff_id=${vo.staff_id}" class="btn blue backbone" ><i class="fa fa-pencil-square-o"></i>生成</a>`
                                   }

                                   str+=` <a href="/index.php/Admin/Staff/desc?id=${vo.staff_id}" class="btn blue"><i class="fa fa-pencil-square-o"></i>详情</a>
                                </div>
                            </td>
                            <td align="" class="" style="width: 100%;">
                                <div>&nbsp;</div>
    ...
    $(document).on('click',".backbone",function(){
