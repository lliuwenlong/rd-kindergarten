<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view/teach/clocking_in.html";i:1548727908;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="ayou_div1">
                                ...
                                <tr>
                                    ...
                                    <!--<td align="center" class="handle">-->
                                        <!--<div style="text-align: center; width: 170px; max-width:170px;">-->
                                            ...
                                            <!--&lt;!&ndash;<a href="<?php echo U('Admin/admin_info',array('admin_id'=>$vo['admin_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>详情</a>&ndash;&gt;-->
                                        <!--</div>-->
                                    <!--</td>-->
        ...
        <script>
            $(document).on('click',".cl",function(){
                ...
                $.ajax({
                    url:"/index.php?m=Admin&c=Teach&a=getclocking_inData",
                    data:{"arr":arr},
                    type:'post',
                    dataType:'json',
                    success:function(res){
                            ...
                            str +=`
                              <tr>
                                    ...
                                    <td align="left" class="">
                                        ...
                                        if(vo.status==1){str+="正常"}else if(vo.status==0){str +="请假"}else{str+="缺勤"}
