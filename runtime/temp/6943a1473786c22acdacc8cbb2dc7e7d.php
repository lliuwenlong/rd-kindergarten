<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view/techang/index.html";i:1548753710;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table>
                    ...
                    <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;"><?php echo $vo['bili']; ?></div>
                            </td>
                            <td align="left" class="">
            ...
            success:function(res){
                ...
                $.each(res,function(i,vo){
                    str +=`
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 100px;">${vo.bili}</div>
                            </td>
                            <td align="left" class="">
