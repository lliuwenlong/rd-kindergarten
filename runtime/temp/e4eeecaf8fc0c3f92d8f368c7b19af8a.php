<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"./application/admin/view/student/student_source.html";i:1548658471;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo $vo['birthday']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 100px;"><?php echo $vo['f_name']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 150px;"><?php echo $vo['tel']; ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="">
								<div style="text-align: left; width: 150px;"><?php if($vo['idea'] == 1): ?>
										强烈
										<?php else: if($vo['idea'] == 2): ?>
											正常
											<?php else: ?>
											放弃
										<?php endif; endif; ?></div>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 150px;"><?php echo $vo['source_name']; ?></div>
							</td>
							<td align="center" class="handle">
								<div style="text-align: center; width: 150px; max-width:170px;">
									<a href="<?php echo U('Student/txxx',array('id'=>$vo['id'])); ?>" class="btn blue detail" u_id="<?php echo $vo['user_name']; ?>"><i class="fa fa-pencil-square-o "></i>填写</a>
									<a href="<?php echo U('Student/student_add',array('id'=>$vo['id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>入园</a>
									<a href="<?php echo U('Student/txshow',array('id'=>$vo['id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>查看</a>
									<a href="<?php echo U('Student/source_del',array('id'=>$vo['id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>删除</a>
			...
			success:function(res){
				...
				$.each(res,function(i,vo){
                    ...
                    str+=`
							...
							<td align="center" class="handle">
								<div style="text-align: center; width: 150px; max-width:170px;">
									<a href="/index.php?m=Admin&c=Student&a=txxx&id=${vo.id}" class="btn blue detail"><i class="fa fa-pencil-square-o "></i>填写</a>
									<a href="/index.php?m=Admin&c=Student&a=student_add&id=${vo.id}" class="btn blue"><i class="fa fa-pencil-square-o"></i>入园</a>
									<a href="/index.php?m=Admin&c=Student&a=txshow&id=${vo.id}" class="btn blue"><i class="fa fa-pencil-square-o"></i>查看</a>
									<a href="/index.php?m=Admin&c=Student&a=source_del&id=${vo.id}" class="btn blue"><i class="fa fa-pencil-square-o"></i>删除</a>
