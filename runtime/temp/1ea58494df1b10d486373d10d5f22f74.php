<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./application/admin/view/staff/job.html";i:1548670478;s:55:"/home/www/yey/application/admin/view/public/layout.html";i:1548654013;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: left; width: 100px;" class="">最后一次登录时间</div>
                        </th>
...
<script>
    $(document).on('click',".cl",function(){
        ...
        $.ajax({
            url:"/index.php?m=Admin&c=Staff&a=getjobData",
            data:{"arr":arr},
            type:'post',
            dataType:'json',
            success:function(res){
