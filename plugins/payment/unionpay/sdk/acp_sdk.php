...
$sdk_array =[
	...
	"acpsdk.frontUrl"=>"http://www.pay.cn/upacp_demo_b2c/demo/api_01_gateway/FrontReceive.php",
	//;;;;;;;;;;;;;;;;;;;;;;;;;入网测试环境签名证书配置 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	//; 多证书的情况证书路径为代码指定，可不对此块做配置。
	//; 签名证书路径，必须使用绝对路径，如果不想使用绝对路径，可以自行实现相对路径获取证书的方法；测试证书所有商户共用开发包中的测试签名证书，生产环境请从cfca下载得到。
	//; 测试环境证书位于assets/测试环境证书/文件夹下，请复制到d:/certs文件夹。生产环境证书由业务部门邮件发送。
	//; windows样例：
	"acpsdk.signCert.path"=> $dir . "/certs/yunchabao.pfx",
	...
	"acpsdk.signCert.pwd"=>"584168",

	//;;;;;;;;;;;;;;;;;;;;;;;;;加密证书配置;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	// 敏感信息加密证书路径(商户号开通了商户对敏感信息加密的权限，需要对 卡号accNo，pin和phoneNo，cvn2，expired加密（如果这些上送的话），对敏感信息加密使用)
	"acpsdk.encryptCert.path"=> $dir . "/certs/acp_prod_enc.cer",

	//;;;;;;;;;;;;;;;;;;;;;;;;;验签证书配置;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	// 验签中级证书（证书位于assets/测试环境证书/文件夹下，请复制到d:/certs文件夹）
	"acpsdk.middleCert.path"=> $dir . "/certs/acp_prod_middle.cer",
	// 验签根证书（证书位于assets/测试环境证书/文件夹下，请复制到d:/certs文件夹）
	"acpsdk.rootCert.path"=> $dir . "/certs/acp_prod_root.cer",

	//;;;;;;;;;;;;;;;;;;;;;;;;;日志配置;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	// 日志打印路径，linux注意要有写权限
	"acpsdk.log.file.path"=> $dir . "/logs/",
